...
@EnableJpaRepositories(basePackages = "pl.primesystems.clientsystem")
public class HibernateConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("pl.primesystems.clientsystem");
    ...
    private Properties hibernateProperties() {
        ...
        properties.put("hibernate.physical_naming_strategy", environment.getProperty("hibernate.physical_naming_strategy"));
